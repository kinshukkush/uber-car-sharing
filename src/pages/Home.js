  ...
  return (
    <div className={`home-container ${isVisible ? 'visible' : ''}`}>
      ...
      <div className="hero-section" ref={topContainerRef}>
        ...
        >
          <motion.div className="left-section" id="enter" variants={itemVariants}>
            <h1>Go Anywhere with <span className="highlight">Car Sharing</span></h1>
            <p className="subtitle">Your journey, our priority. Request a ride, hop in, and go.</p>
          ...
          <motion.div className="right-section" variants={itemVariants}>
            <div className="image-container">
              <img src={UberImage} alt="Car Sharing Cab" className="hero-image" />
            </div>
          </motion.div>
        </motion.div>
      </div>
      ...
      >
        <div className="section-header">
          <h2>Why Choose Car Sharing?</h2>
          <p>Experience the best ride-sharing service with top-notch features</p>
        </div>
        ...
        <div className="features-grid">
          ...
          >
            ...
            <p>Get the best rates for your rides with transparent pricing and no hidden fees.</p>
          </motion.div>
          ...
          >
            ...
            <h3>Safety First</h3>
            <p>Your safety is our priority with verified drivers and real-time trip tracking.</p>
          </motion.div>
          ...
          >
            ...
            <p>Enjoy a comfortable journey with well-maintained vehicles and professional drivers.</p>
          </motion.div>
        </div>
      </motion.section>
